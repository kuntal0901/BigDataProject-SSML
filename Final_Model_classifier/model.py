...
def load_model():
    ...
    models=[]
    models.append(joblib.load('Bernoulli.jobllib'))
    models.append(joblib.load('PassiveAggressive.jobllib'))
    models.append(joblib.load('SGD.jobllib'))
    return models
